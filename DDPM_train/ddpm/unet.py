...
class SelfAttention(nn.Module):
    def __init__(self, in_channel,norm,num_groups,n_head=4):
        super().__init__()
...
#         in_channels (int): number of input channels
#     """
#     def __init__(self, in_channels, norm="gn", num_groups=16):
#         super().__init__()
...
class ResidualBlock(nn.Module):
    ...
    def __init__(
        ...
        self.attention = nn.Identity() if not use_attention else SelfAttention(out_channels, norm, num_groups)
