...
def create_argparser():
    ...
    parser.add_argument('--moving',  help='moving image (source) filename',default='D:\\Desktop\\diffusion model code\\voxelmorph-dev\\data\\train\\T2\\OAS30005_MR_d0581_T2w.nii.gz')
    parser.add_argument('--fixed', help='fixed image (target) filename',default='D:\\Desktop\\diffusion model code\\voxelmorph-dev\\data\\train\\T1\\OAS30004_MR_d1101_T1w.nii.gz')
    parser.add_argument('--moved', help='warped image output filename',default='result\\DCT\\OAS30003_MR_d02682_T2w_to_OAS30004_MR_d1101_T1w_t2_DCT.nii.gz')
    parser.add_argument('--model',  help='pytorch model for nonlinear registration',default='model\\models_DCT_MSE_t2tot1\\1500.pt')
    parser.add_argument('--warp', help='output warp deformation filename',default='result\\DCT\\warp_OAS30003_MR_d02682_T2w_to_OAS30004_MR_d1101_T1w_t2_DCT.nii.gz')
