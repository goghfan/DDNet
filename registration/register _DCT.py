...
import voxelmorph_baseline as vxm 
...
def create_argparser():
    ...
    parser.add_argument('--moving',  help='moving image (source) filename',default='D:\\Desktop\\diffusion model code\\voxelmorph-dev\\data\\train\\T1\\OAS30003_MR_d2669_T1w.nii.gz')
    parser.add_argument('--fixed', help='fixed image (target) filename',default='D:\\Desktop\\diffusion model code\\voxelmorph-dev\\data\\train\\T2\\OAS30001_MR_d0129_T2w.nii.gz')
    parser.add_argument('--moved', help='warped image output filename',default='result\\ablation_study\\result_ncc_vm.nii.gz')
    parser.add_argument('--model',  help='pytorch model for nonlinear registration',default='model\\models_ncc_noddpm\\1300.pt')
    parser.add_argument('--warp', help='output warp deformation filename',default='result\\ablation_study\\warped_ncc_vm.nii.gz')
