...
def create_argparser():
    ...
    parser.add_argument('--model',  help='pytorch model for nonlinear registration',default='D:\\Desktop\\diffusion model code\\voxelmorph-dev\model\models_ncc\\1500.pt')
...
for i in tqdm(range(200)):
    ...
    save_file="result\\DCT\\onlyDDPM\\"+moving_path[moving_path.find('OAS'):moving_path.find('.nii.gz')]+"_to_"+ fixed_path[fixed_path.find('OAS'):fixed_path.find('.nii.gz')]+".nii.gz"
    deformation_file = "result\\DCT\\onlyDDPM\\"+moving_path[moving_path.find('OAS'):moving_path.find('.nii.gz')]+"_to_"+ fixed_path[fixed_path.find('OAS'):fixed_path.find('.nii.gz')]+"_deformation.nii.gz"
