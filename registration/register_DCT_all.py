...
for i in tqdm(range(200)):
    ...
    save_file="result\\DCT\\prueVM\\"+moving_path[moving_path.find('OAS'):moving_path.find('.nii.gz')]+"_to_"+ fixed_path[fixed_path.find('OAS'):fixed_path.find('.nii.gz')]+".nii.gz"
    deformation_file = "result\\DCT\\prueVM\\"+moving_path[moving_path.find('OAS'):moving_path.find('.nii.gz')]+"_to_"+ fixed_path[fixed_path.find('OAS'):fixed_path.find('.nii.gz')]+"_deformation.nii.gz"
